    ...
    <>
      ...
      <div className="flex justify-between mt-10">
        ...
        <div className="p-5 lg:w-[500px] lg:mb-4">
          <h1 className="text-[color:hsl(26,100%,55%)] font-bold uppercase tracking-widest lg:text-[12px] sm: text-[14px]">
            sneaker company
          </h1>
          <h2 className="text-[color:hsl(220,13%,3%)] text-3xl font-bold my-4 lg:text-4xl">
          ...
          <section className="flex items-center justify-between mt-7 lg:flex-col lg:items-start lg:gap-2">
          ...
          <div className="mt-8 lg:flex lg:items-center lg:gap-4">
            <button className="flex items-center justify-between w-full bg-[color:hsl(223,64%,98%)] shadow-lg shadow-gray-300/40  py-4 px-6 rounded-xl cursor-pointer lg:w-[150px]">
              <img
